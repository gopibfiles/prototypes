  ...
  const candidates = [
    {
      ...
      currentTitle: "Junior Accountant",
      desiredTitle: "Accountant",
    ...
    },
    {
      ...
      currentTitle: "Senior Bookkeeper",
      desiredTitle: "Accountant",
      location: "Islington, London",
      eligibility: "Eligible to work in UK",
      skills: ["Bookkeeping", "Reconciliation", "VAT Returns"],
    },
    {
      name: "Amara",
      active: "Last active 3 hours ago",
      currentTitle: "Accounts Assistant",
      desiredTitle: "Senior Accountant",
      location: "Holborn, London",
      eligibility: "Eligible to work in UK",
      skills: ["Management Accounts", "Reconciliation"],
    },
    {
      name: "Daniel",
      active: "Last active 2 days ago",
      currentTitle: "Finance Assistant",
      desiredTitle: "Accountant",
      location: "Westminster, London",
      eligibility: "Eligible to work in UK",
      skills: ["Reconciliation", "VAT Returns", "Excel"],
    },
  ];
